...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [WNATIVE[ChainId.GOERLI], CAKE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
  [ChainId.GOERLI]: [WNATIVE[ChainId.RINKEBY], CAKE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
  [ChainId.BSC]: [
    bscTokens.wbnb,
    bscTokens.cake,
    bscTokens.busd,
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.GOERLI_ARBI]: [USDT[ChainId.GOERLI_ARBI]],
}
...
export const MIN_BNB: JSBI = JSBI.exponentiate(BIG_INT_TEN, JSBI.BigInt(4)) // .001 BNB
...
// BNB
export const DEFAULT_INPUT_CURRENCY = 'SPC'
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0x5d790F57ceC5a52CE22D6327b4d0bD664cf38ac8'
