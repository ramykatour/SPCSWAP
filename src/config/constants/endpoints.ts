...
export const INFO_CLIENT = 'https://api.studio.thegraph.com/query/55944/devo-subgraph/version/latest'
export const BLOCKS_CLIENT = 'https://api.studio.thegraph.com/query/55944/devo-subgraph/version/latest'
